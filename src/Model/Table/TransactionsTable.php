...
class TransactionsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setDisplayField('OrderDate');
        $this->setPrimaryKey(['OrderDate', 'SoldBy', 'PurchasedBy']);
    }
    ...
    public function validationDefault(Validator $validator)
    {
        $validator
            ->dateTime('OrderDate')
            ->allowEmpty('OrderDate', 'create');

        $validator
            ->integer('SoldBy')
            ->allowEmpty('SoldBy', 'create');

        $validator
            ->integer('PurchasedBy')
            ->allowEmpty('PurchasedBy', 'create');
